...
const MillionairesProblem = artifacts.require('Sample.sol');
...
module.exports = async function(deployer, network, accounts) {
    ...
    deployer.deploy(MillionairesProblem).then(function() {
        console.log(`Smart Contract "Sample.Sol" has been deployed at ETH address: ${MillionairesProblem.address}`);
        return;
    });
    ...
    let address = await deploySecretContract(config);
